...
class ApiClient {
    ...
    async _post(action, payload = {}) {
        // Verificar si la URL sigue con el valor por defecto de configuración
        if (this.scriptUrl.includes('TU_URL')) {
    ...
    async verificarCodigo(codigo) {
        ...
        return {
            ...
            nombre: result.nombre || 'Estudiante SJ'
        };
    }
    ...
    async getRanking(modo) {
        ...
        // Si el script retorna un array directamente o dentro de una propiedad 'ranking'
